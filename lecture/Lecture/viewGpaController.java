...
public class viewGpaController {
    ...
    @FXML
    private void searchGpa(ActionEvent actionEvent){
    ...
    private void loadGpaData(String tgFilter) throws SQLException {
        ...
        String sql = """
                SELECT 
                    ...
                    ROUND(SUM(
                        CASE 
                            WHEN cu.gpa_state = 'GPA' THEN cu.credit * 
                                CASE fm.grade
                                    WHEN 'A+' THEN 4.0
                                    WHEN 'A'  THEN 4.0
                                    WHEN 'A-' THEN 3.7
                            ...
                            ELSE 0
                        END
                    ) / NULLIF(SUM(CASE WHEN cu.gpa_state = 'GPA' THEN cu.credit ELSE 0 END), 0), 2) AS cgpa
