...
//                stmt.close();
    ...
    public void handleAddMarks(ActionEvent event){
        ...
        if(conn != null){
            ...
            try {
                ...
                //load managecourse.fxml
                FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("fxml/courseSelect.fxml"));
                //Parent root = null;
                Parent root = null;
                try {
                    root = loader.load();
    ...
    public void handleEligibility(){
        ...
        if(conn != null){
            ...
            try {
                ...
                //load managecourse.fxml
                FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("fxml/courseSelectForEligibility.fxml"));
                //Parent root = null;
                Parent root = null;
                try {
                    root = loader.load();
    ...
    public void handleViewGpa(ActionEvent event) {
        ...
        if(conn != null){
            System.out.println("database connected successfully");
                //load managecourse.fxml
                FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("fxml/viewGpa.fxml"));
            Parent root = null;
            try {
                root = loader.load();
                Scene scene = new Scene(root);
