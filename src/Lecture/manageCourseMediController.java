...
public class manageCourseMediController {
    ...
    public void handleCourseButton(ActionEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("fxml/viewMedical.fxml"));
            Parent root = loader.load();

            viewMedicalDetails controller = loader.getController();
