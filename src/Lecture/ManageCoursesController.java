...
public class ManageCoursesController {
        ...
        public void handleCourseButton(ActionEvent event){
          ...
          cLable = fields[index].getText();
            ...
            try {
                FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("fxml/ManageCourseDetails.fxml"));
                Parent root = loader.load();

                ManageCourseDetailsController controller = loader.getController();
                controller.setCourseLabel(cLable);
